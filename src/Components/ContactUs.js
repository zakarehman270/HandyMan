        ...
        <Row className="mt-4">
          <Col>
            <div className="d-flex align-items-center Gap mb-4">
              ...
              <div>
                <h5 className="mb-1">Office #714, Le Solarium,</h5>
              ...
              <Row className="mb-3">
                <Form.Group controlId="validationCustom03">
                  ...
                  <Form.Control
                    ...
                    required
                    defaultValue={
                      "We want to serve you better and are committed to continuously improving our client service standards. To do this, let us know what you think!"
                    }
                    style={{ height: "100px" }}
                  />
